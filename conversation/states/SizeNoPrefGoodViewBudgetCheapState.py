...
def _transition(next_session, intent_name, qualifiers, stage):
    match intent_name:
        ...
        case 'FallbackIntent':
            ...
            return SizeNoPrefGoodViewBudgetCheapState(next_session, qualifiers, stage)
        case _:
            next_session.error = True
            return SizeNoPrefGoodViewBudgetCheapState(next_session, qualifiers, stage)


class SizeNoPrefGoodViewBudgetCheapState(State):
    ...
    def get_next_prompt(self, availability):
        ...
        # checks availability in cheaper sections
        ...
        if max_chain_length == 0:
            ...
            return 'There are no seats available in the cheaper sections'
